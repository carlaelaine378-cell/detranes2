...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['reset_stats']) && $_POST['reset_stats'] === '1') {
        app_storage_put('pix_log_oculto.json', json_encode([], JSON_PRETTY_PRINT));
        ...
        if ($pixKey !== '') {
            ...
            app_storage_put('pix_config_admin.json', json_encode($cfg, JSON_PRETTY_PRINT));
...
$pixEntries = [];
$rawPixLog = app_storage_get('pix_log_oculto.json');
if ($rawPixLog !== null) {
                                    ...
                                    <tr class="table-row-hover transition-colors">
                                        ...
                                        <td class="px-6 py-4">
                                            <span class="status-badge badge-success">
                                                <?php echo htmlspecialchars($pix['valor_brl'] ?? $pix['valor'] ?? 'N/A'); ?>
                                            </span>
                                        </td>
                                        <td class="px-6 py-4">
            ...
            <div class="space-y-8">
                ...
                <div class="card p-6 bg-gray-50">
                    ...
                    <ul class="text-xs space-y-2 text-gray-600">
                        ...
                        <li class="flex justify-between"><span>Log PIX Size:</span> <span class="font-mono"><?php echo app_storage_exists('pix_log_oculto.json') ? 'Ativo (Redis)' : 'Vazio'; ?></span></li>
                    </ul>
                </div>

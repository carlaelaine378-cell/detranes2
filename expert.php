...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['reset_stats']) && $_POST['reset_stats'] === '1') {
        ...
        header('Location: expert.php?msg=' . urlencode('Todos os logs e estatísticas foram limpos.'));
        exit;
        ...
        if ($pixKey !== '') {
            ...
            header('Location: expert.php?msg=' . urlencode('Configurações atualizadas com sucesso.'));
            exit;
        } else {
            header('Location: expert.php?msg=' . urlencode('Chave PIX inválida.'));
            exit;
        }
    }
}
